<template>
<div role="status" class="w-full border border-gray-200 rounded shadow animate-pulse dark:border-gray-500">
    <div class="flex items-center justify-center h-48 mb-4 bg-gray-500 rounded dark:bg-gray-500">
    ...
    <div class="p-4 md:p-6">
        ...
        <div class="mt-5 h-4 w-16 bg-gray-200 rounded-full dark:bg-gray-500"></div>
